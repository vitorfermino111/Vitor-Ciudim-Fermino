...
public class EstruturaArvore {
    ...
    public void inserir(int ordem, String nome) {
      NoArvore novoNo = new NoArvore(ordem, nome);    // criamos o novo nó

      if(raiz==null)                // se for o primeiro a ser inserido ...
         raiz = novoNo;             // ele será o nó raiz
      else                          // senão ... 
         {
         NoArvore corrente = raiz;        // começamos a nossa busca pelo lugar de inserção pela raiz ...
         NoArvore pai;                    // o nó pai é o que buscamos ...
    ...
    public NoArvore buscar(int ordem) {
        NoArvore corrente = raiz;               // começaremos a busca da raiz
    ...
    public boolean remover(int ordem) {
      NoArvore corrente = raiz;           // corrente é a referência de nó que ficará sobre o nó da vez
      NoArvore pai = raiz;             // é necessário uma referência sobre o pai também ...
      ...
      // nesse caso substituimos pela arvore a direita
         ...
         NoArvore successor = getSuccessor(corrente);
      ...
      private NoArvore getSuccessor(NoArvore delNode)
      {
      NoArvore successorPai = delNode; // o nó sucessorPai começa sendo o nó que queremos deletar ...
      NoArvore successor = delNode;   // o nó sucessor também ...
      NoArvore corrente = delNode.getFilhoDireito();   // vamos para a direita do nó que queremos deletar
